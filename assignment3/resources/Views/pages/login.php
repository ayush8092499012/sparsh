          ...
          <form id="formAuthentication" class="mb-3" action="" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="email" name="email-username" placeholder="Enter your Email"
                autofocus />
              <div id="emailError" class="error-message" style="color: red;"></div> <!-- Error message for email -->
            </div>
            ...
            <div class="mb-3">
              <button type="submit" class="btn btn-primary d-grid w-100" type="submit" id="loginBtn"
...
<script>
  ...
  function validateEmail() {
    ...
    emailField.style.border = ''; // Clear previous border

    const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
    if (email === '') {
      emailError.innerText = 'Email is required.';
      emailField.style.border = '1px solid red'; // Add red border
  ...
  function validatePassword() {
    ...
    passwordField.style.border = ''; // Clear previous border

    if (password === '') {
      passwordError.innerText = 'Password is required.';
      passwordField.style.border = '1px solid red'; // Add red border
    }
  }
  ...
  document.getElementById('formAuthentication').addEventListener('submit', function (event) {
    ...
    if (email && password && !emailError.innerText && !passwordError.innerText) {
      const formData = {
        email: email,
        password: password
      };
